<header style="z-index: 150;">
    <div class="max-height d-flex flex-column justify-content-between">
        <div class="top d-flex flex-column">
            ...
            <button class="mb-3 logo d-flex align-items-center <?php if ($this->uri->uri_string() == 'candidate') {
                                                                    echo 'text-purple';
                                                                } else {
                                                                    echo 'text-secondary';
                                                                } ?>">
            ...
            <button class="mb-3 logo d-flex align-items-center <?php if ($this->uri->uri_string() == 'vacancy') {
                                                                    echo 'text-purple';
                                                                } else {
                                                                    echo 'text-secondary';
                                                                } ?>">
            ...
            <button class="mb-3 logo d-flex align-items-center <?php if ($this->uri->uri_string() == 'apply') {
                                                                    echo 'text-purple';
                                                                } else {
                                                                    echo 'text-secondary';
                                                                } ?>">
                <a href="<?php echo base_url() ?>apply">
                    <i class="far fa-folder h5 mx-3"></i>
                </a>
                <a href="<?php echo base_url() ?>apply">
        ...
        <div class="bottom d-flex flex-column">
            <button id="user-logout" class="mb-1 logo d-flex align-items-center <?php if ($this->uri->uri_string() == 'auth/logout') {
                                                                                    echo 'text-purple';
                                                                                } else {
                                                                                    echo 'text-secondary';
                                                                                } ?>">
